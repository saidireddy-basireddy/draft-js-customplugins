...
export class MyDraft extends React.Component<iMyDraftProps, {}> {
  ...
  // @observable isRecentEmojiListOpen = true;
  ...
  private onChange = (editorState: Draft.EditorState) => {
    ...
    // there should never be an time lag on the editor syncronaization so do it async
  ...
  render() {
      // let recentEmojiList:IEmojiData[] = [{ID:'grinning',Name:':grinning:'},
      //   {ID:'joy',Name:':joy:'},
      //   {ID:'heart_eyes',Name:':heart_eyes:'},
